<template>
  <div>
    ...
    <p class="bg-gray-100 p-16 rounded-4 text-12"><code>yarn add @finn-no/fabric-icons</code></p>
    ...
    <p class="border-l-8 bg-green-50 border-green-700 p-16 rounded-4 my-16 text-12">The naming scheme for exports is <code>Icon+NAME+SIZE</code> - e.g. above this would be the size "32" wifi-icon.</p>
  </div>
</template>
