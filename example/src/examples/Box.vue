  ...
  <div>
    ...
    <docs-table>
      <tr>
        ...
        <td>
          <div>string</div>
          <div class="annotation">The DOM element to emit</div>
        </td>
        <td>div</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>
          <div>boolean</div>
          <div class="annotation">Applies focus and pointer helpers, should be used with other styling to indicate clickability</div>
        </td>
        <td>false</td>
      </tr>
      <tr>
