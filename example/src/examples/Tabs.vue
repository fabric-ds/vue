<template>
  <div>
    <setup title="Tabs" pkg-name="@finn-no/fabric-vue-tabs" compName="fTabs, fTab" />

    <section-header label="Example" />

    <f-tabs v-model="model" :contained="contained">
    ...
    <div :class="{ 'bg-aqua-50 p-24 last-child:mb-0': contained, 'mb-16': !contained }">
      <h3 v-if="model === 'home'">Welcome home!</h3>
