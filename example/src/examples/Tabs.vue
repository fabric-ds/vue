<template>
  <div>
    <setup title="Tabs" pkg-name="@finn-no/fabric-vue-tabs" compName="fTabs, fTab, fTabPanel" />
...
import { fTabs, fTab, fTabPanel } from '@finn-no/fabric-vue-tabs'
...
export default {
  components: { fTabs, fTab, fTabPanel, Setup, Stars },
  setup() {
